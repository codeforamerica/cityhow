...
?>	
	<div class="form-item">
		...
		<input autocomplete="off" name="pass1" id="pass1<?php $template->the_instance(); ?>" class="input" tabindex="30" size="20" value="" type="password" />	
	...
	<div class="form-item">
		...
		<input autocomplete="off" name="pass2" id="pass2<?php $template->the_instance(); ?>" class="input" tabindex="30" size="20" value="" type="password" />
