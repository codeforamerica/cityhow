...
<?php endif; ?>			
			...
			<div class="form-item">
				...
				<div class="help-block <?php foreach ($nh_error_keys as $key) { if ($key == "maxlength_description") { echo 'nh-error'; }} ?>"><span class="txt-help"><span class="field-hint"></span>This description is publicly visible, so share a little information about yourself. The character limit is 200 characters.</span>
				</div>
			</div>	
			...
			<div class="form-item">
				...
				<div class="help-block <?php foreach ($nh_error_keys as $key) { if ($key == "invalid_url") { echo 'nh-error'; }} ?>"><span class="txt-help"><span class="field-hint"></span>If you have a website, copy the URL here. This URL will be publicly visible.</span>
				</div>
			</div>	
