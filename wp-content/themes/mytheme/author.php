...
// Viewer author doesnt have posts	
		...
		echo '<h5>You haven&#39;t created any CityHow content yet!</h5>';
		echo '<p>Start by creating a <a class="nhline" href="'.$app_url.'/create-guide" title="Create a CityHow Guide">CityHow Guide</a>, or <a class="nhline" href="'.$app_url.'/guides" title="Explore CityHow Guides">explore other Guides</a> for inspiration.';
	}
...
<?php
	...
	// Author doesnt have posts	
		...
		echo '<h5>This author hasn&#39;t created any public CityHow content yet. Stay tuned!</h5>';
	}	
...
if (!$comments AND $current_user->ID == $curauth->ID) {
	...
	echo '<p class="author-list style="margin-top:.25em;font-size:.9em">Join the CityHow conversation by exploring some <a class="nhline" href="'.$app_url.'/guides" title="Explore CityHow Guides">CityHow Guides</a>.</p>';
}
if (!$comments AND $current_user->ID != $curauth->ID) {
...
if (!$likes AND $current_user->ID == $curauth->ID) {
	...
	echo '<p class="author-list" style="margin-top:.25em;font-size:.9em">Start exploring some <a class="nhline" href="'.$app_url.'/guides" title="Explore CityHow Guides">CityHow Guides</a>.</p>';
}
...
if (!$votes AND $current_user->ID == $curauth->ID) {
	...
	echo '<p class="author-list" style="margin-top:.25em;font-size:.9em">Explore <a class="nhline" href="'.$app_url.'/ideas" title="View CityHow ideas">some of the ideas</a> from other people.</p>';
}
