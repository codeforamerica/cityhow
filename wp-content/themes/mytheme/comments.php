...
$comments_args = array(
	...
	'comment_notes_before'  =>  '<p class="comment-notes">' . __( 'To add your comment, <a href="'.$app_url.'/signin" title="Sign In">please sign in to CityHow</a>.' ).'</p>'
);
...
?>
<p class="comment-notes">To add a comment, <a href="<?php echo $app_url;?>/signin" title="Sign In">please sign in to CityHow</a>.</p>
<?php
endif; // end if user is loggedin
