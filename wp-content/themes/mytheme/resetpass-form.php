...
<div id="content">
	<div id="page-register">
		<h3 class="page-title">Reset Your CityHow Password</h3>
...
<ahref=do.php>
				<div class="form-item">
					...
					<div class="help-block <?php if ($value == 'password_reset_mismatch') { echo 'nh-error'; } ?>"><span class="txt-help">Enter your new password. It should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).</span>
					</div>
				</div>
